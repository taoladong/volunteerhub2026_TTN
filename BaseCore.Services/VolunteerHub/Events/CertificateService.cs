...
namespace BaseCore.Services.VolunteerHub
{
    public class CertificateService : ICertificateService
    {
        ...
        public CertificateService(BaseCore.Repository.EFCore.IUnitOfWork unitOfWork, INotificationService notificationService, IBadgeService badgeService)
        {
        ...
        public async Task IssueCertificatesForEventAsync(int eventId)
        {
            ...
            var attended = await _unitOfWork.Registrations.GetQueryable()
            ...
            foreach (var reg in attended)
            {
                ...
                var already = await _unitOfWork.Certificates.GetQueryable()
                ...
                var profile = await _unitOfWork.VolunteerProfiles.GetQueryable().FirstOrDefaultAsync(p => p.UserId == reg.UserId);
                if (profile != null)
                {
                ...
                await _unitOfWork.CertificateJobs.AddAsync(new CertificateJob
                {
        ...
        {
            return await _unitOfWork.Certificates.GetQueryable()
