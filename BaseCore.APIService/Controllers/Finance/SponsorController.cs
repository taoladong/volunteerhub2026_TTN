...
namespace BaseCore.APIService.Controllers
{
    ...
    public class SponsorController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMySponsorshipTracking(int sponsorshipId)
        {
            ...
            var sponsorship = await _unitOfWork.EventSponsors.GetQueryable()
            ...
            var registrations = await _unitOfWork.Registrations.GetQueryable()
                ...
                .ToListAsync();
            var certificatesIssued = await _unitOfWork.Certificates.GetQueryable().CountAsync(c => c.EventId == eventId);
