...
namespace BaseCore.APIService.Controllers
{
    ...
    public class SponsorProfileController : ControllerBase
    {
        ...
        public SponsorProfileController(BaseCore.Repository.EFCore.IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IActionResult> GetProfile()
        {
            ...
            var profile = await _unitOfWork.SponsorProfiles.GetQueryable()
                .AsNoTracking()
            ...
            if (profile == null)
            {
                ...
                await _unitOfWork.SponsorProfiles.AddAsync(profile);
