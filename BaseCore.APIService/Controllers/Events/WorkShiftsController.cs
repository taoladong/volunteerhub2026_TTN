...
namespace BaseCore.APIService.Controllers
{
    ...
    public class WorkShiftsController : ControllerBase
    {
        ...
        public WorkShiftsController(IWorkShiftRepositoryEF repo, IEventRepositoryEF eventRepo, IAuditLogService auditLogService, IChannelService channelService, BaseCore.Repository.EFCore.IUnitOfWork unitOfWork)
        {
            _repo = repo;
        ...
        public async Task<IActionResult> GetByEvent(int eventId)
        {
            ...
            var counts = await _unitOfWork.Registrations.GetQueryable()
        ...
        public async Task<IActionResult> Delete(int eventId, int id)
        {
            ...
            var activeRegs = await _unitOfWork.Registrations.GetQueryable().CountAsync(r => r.ShiftId == id && (r.Status == "Pending" || r.Status == "Confirmed"));
            if (activeRegs > 0)
            ...
            var subChannel = await _unitOfWork.Channels.GetQueryable()
                .Include(c => c.Posts)
            ...
            if (subChannel != null)
            {
                ...
                await _unitOfWork.Channels.DeleteAsync(subChannel);
